    ...
    <section className='container w-full space-y-20'>
      ...
      <article className='my-[20%] space-y-2 px-4'>
        ...
        <div className='w-full grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 text-center p-4'>
          ...
          <div className='border aspect-square flex items-center justify-center p-4'>Webデザイナー</div>
          <div className='border aspect-square flex items-center justify-center p-4'>SNS管理チーム</div>
          <div className='border aspect-square flex items-center justify-center p-4'>宅内自宅ファイバー設定係</div>
          <div className='border aspect-square flex items-center justify-center p-4'>セールスマネージャー</div>
          <div className='border aspect-square flex items-center justify-center p-4'>セールスレップ</div>
        </div>
      </article>
