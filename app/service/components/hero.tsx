...
export default function Hero() {
  return (
    <div className='relative w-full h-auto my-30 md:my-0 md:h-screen overflow-hidden'>
      ...
      <div className='container h-full flex flex-col-reverse md:flex-row justify-around items-center text-center md:text-left px-4 sm:px-6'>

        {/* テキスト部分 */}
        <div className='w-full md:w-auto mt-6 md:mt-0'>
          <small className='block w-full font-bold text-center text-white mb-2 md:mb-0 drop-shadow'>
            「これは面白い！を創り ∴ 自由を広げる。」
          </small>
