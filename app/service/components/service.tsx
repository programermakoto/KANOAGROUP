...
export default function Service() {
    ...
    return (
        <div className='container'>
            ...
            <section className='flex items-center  w-9/10 mx-auto h-96 gap-6 my-[50px]'>
                <div className='w-1/2  p-[18px] h-full flex flex-col justify-center'>
                    <div>
                        ...
                        <p className='text-gray-700 mb-6 leading-relaxed '>お客様宅に訪問し、光ファイバーインターネット（EO光）の開通に伴うWi-Fi設定や通信環境の最適化を行うサービスです。
                            接続設定から動作確認までを一貫してサポートし、初めての方でも安心してご利用いただけるよう丁寧に対応いたします。</p>
                    </div>
                    <div className='flex justify-center gap-5 items-center  w-1/2 mx-auto'>
                        ...
                        <Link href="https://lin.ee/N8Z79Gm" target="_blank" rel="noopener noreferrer">
                            <Button
                                className="block text-white bg-sky-600 hover:bg-orange-500 hover:text-white transition duration-[500ms]"
                                variant="outline"
                            >
                                お問い合わせ
                            </Button>
                ...
                <div className='w-1/2  p-[18px] h-full flex items-center justify-center'>
                    <Image
                        src="/eo-image.webp"
                        alt="EO光業務風景画像"
                        width={300}
            ...
            <section className='flex flex-row-reverse items-center  w-9/10 mx-auto h-96 gap-6 my-[50px]'>
                <div className='w-1/2   p-[18px] h-full flex flex-col justify-center'>
                    <div>
                        <h1 className='text-3xl text-gray-700 font-bold'>未来塾</h1>
                        <small className='block text-gray-700 text-sm mb-2'>プログラミングスクール</small>
                        <p className='text-gray-700 mb-6 leading-relaxed '>未来塾は、プログラミング・マーケティング・デザイン・動画編集など、
                            これからの時代に必要とされるスキルを幅広く学べる教育スクールです。
                            知識を“使える力”へと変える実践型カリキュラムを採用し、
                            年齢や経験に関係なく、自分の可能性を最大限に伸ばせる学びの場を提供しています。</p>
            ...
            <section className='flex items-center  w-9/10 mx-auto h-96 gap-6 my-[50px]'>
                <div className='w-1/2  p-[18px] h-full flex flex-col justify-center'>
                    <div>
                        ...
                        <p className='text-gray-700 mb-6 leading-relaxed '>KANOA GROUPのホームページ制作事業では、最短1週間で高クオリティなWebサイトを提供しています。
                            デザイン性と操作性を両立し、3Dモデルやアニメーションを取り入れた“魅せるサイト”を制作。
                            企業や店舗のブランド価値を最大限に引き出す、戦略的なWebデザインを提案しています。</p>
            ...
            <section className='flex flex-row-reverse items-center  w-9/10 mx-auto h-96 gap-6 my-[50px]'>
                <div className='w-1/2   p-[18px] h-full flex flex-col justify-center'>
                    <div>
                        ...
                        <small className='block text-gray-700 text-sm mb-2'>新規ビジネス創出を目的とした、オーダーメイドの開発</small>
                        <p className='text-gray-700 mb-6 leading-relaxed '>クライアントの課題や目的に合わせた、完全オリジナルのアプリ・システムを開発しています。
                            自社開発アプリ「GK-U」で培ったUI/UX設計・機能開発のノウハウを活かし、
                            操作性と拡張性を両立したプロダクトをスピーディーに提供。
                            業務効率化から顧客体験向上まで、一貫した開発体制で支援します。</p>
            ...
            <section className='flex items-center  w-9/10 mx-auto h-96 gap-6 my-[50px]'>
                <div className='w-1/2  p-[18px] h-full flex flex-col justify-center'>
                    <div>
                        ...
                        <p className='text-gray-700 mb-6 leading-relaxed '>塾に行く交通費用や時間は不必要。この「GK-U」アプリひとつで「Webマーケティング・サイト制作・アプリ開発・ADOBE」を学習できます。</p>
