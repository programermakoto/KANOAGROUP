...
export default function Mission() {
  return (
    <div className='w-2/3 py-20 h-auto lg:h-screen mx-auto flex flex-col justify-center items-center '>
      <h2 className='my-4  text-3xl text-center'>Mission & Vision</h2>
