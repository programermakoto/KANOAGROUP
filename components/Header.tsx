        ...
        <div className="px-4 pt-4 pb-6 space-y-2">
          <Link href="/service" className="block w-full">
            <Button variant="ghost" asChild className="w-full justify-start">
              <span className="w-full text-left">事業内容</span>
            </Button>
          </Link>
          <Link href="/about" className="block w-full">
            <Button variant="ghost" asChild className="w-full justify-start">
              <span className="w-full text-left">会社概要</span>
            </Button>
          </Link>
          <Link href="/news" className="block w-full">
            <Button variant="ghost" asChild className="w-full justify-start">
              <span className="w-full text-left">企業連絡</span>
            </Button>
          </Link>
          <Link href="/recruitment" className="block w-full">
            <Button variant="ghost" asChild className="w-full justify-start">
              <span className="w-full text-left">採用情報</span>
            </Button>
          </Link>
          <Link href="/contact" className="block w-full">
            <Button variant="ghost" asChild className="w-full justify-start">
              <span className="w-full text-left">お問合わせ</span>
            </Button>
          </Link>
        </div>
      </div>
