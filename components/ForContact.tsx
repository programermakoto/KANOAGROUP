    ...
    <div className="relative container my-20 md:my-30 h-auto md:h-[60vh] w-full md:w-4/5 mx-auto flex justify-center items-center perspective-1000">
      <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-10 w-full">
        ...
        <div className="w-full md:w-1/3 flex justify-center md:justify-end px-4 relative">
          ...
          {/* 背景装飾の丸 */}
          <div className="absolute -top-10 -left-10 w-20 h-20 bg-orange-500 rounded-full opacity-40 animate-float-slow" />
          <div className="absolute -bottom-8 right-0 w-16 h-16 bg-red-600 rounded-full opacity-30 animate-float-slower" />
          <div className="absolute top-1/2 left-1/4 w-12 h-12 bg-green-600 rounded-full opacity-30 animate-float-fast" />
          <div className="absolute bottom-1/3 right-1/4 w-10 h-10 bg-sky-600 rounded-full opacity-20 animate-float-fast" />
        </div>
