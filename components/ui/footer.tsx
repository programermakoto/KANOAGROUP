...
export default function Footer() {
    return (
        <footer className="sticky top-full min-h-16 flex flex-col items-center px-6 border-t py-4">
            <div className='text-gray-700 flex justify-between w-full max-w-4xl'>
                <div className="flex flex-col space-y-2">
                    <h3 className='text-center py-1 border-b-2'>規約事項等 (POLICY)</h3>
                ...
                <div className="flex flex-col space-y-2">
                    <h3 className='text-center py-1 border-b-2'>お問い合わせ(CONTACT)</h3>
                ...
                <div className="flex flex-col space-y-2">
                    <h3 className='text-center py-1 border-b-2'>関連会社HP(COMPANY)</h3>
